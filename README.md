...
├── 01_Paper/          # Full research paper
├── 02_Data/           # Data cleaning documentation
├── 03_SQL/            # Database schema and queries
├── 04_PowerBI/        # Power BI dashboard documentation
├── 05_Figures/        # Dashboard figures
└── 06_References/     # Reference list
---
...
- Platform names → generic descriptions

The anonymization mapping document is maintained 
separately and is not publicly available.
